...
public class JavaFxDisplayAndEdit implements DisplayAndEdit {
    ...
    public JavaFxDisplayAndEdit() {
        ...
        display.addEventFilter(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent mouseEvent) {
                edit();
            }
        });
        edit.addEventHandler(KeyEvent.KEY_PRESSED, new EventHandler<KeyEvent>() {
            @Override
    ...
    private void edit() {
        ...
        edit.focusedProperty().addListener(new ChangeListener<Boolean>() {
            @Override
